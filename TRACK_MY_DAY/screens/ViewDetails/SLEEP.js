...
const SLEEP = () => {
    ...
    const percentage = (average/sleepGoal) * 100;
  ...
  return (
    ...
    <View style={styles.container}>
        ...
        />
        <Text style={styles.percentText}>You've achieved <Text style={{fontSize: 20, fontWeight: '500', color: '#B1303B'}}>{ percentage.toPrecision(3) }%</Text> of your sleep goal. Keep going!</Text> 
        </View>
