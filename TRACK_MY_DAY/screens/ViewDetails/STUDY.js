...
const STUDY = () => {
    ...
    const percentage = (average/studyGoal) * 100;
  ...
  return (
    ...
    <View style={styles.container}>
        ...
        />
        <Text style={styles.percentText}>You've achieved <Text style={{fontSize: 20, fontWeight: '500', color: '#B1303B'}}>{ percentage.toPrecision(3) }%</Text> of your study goal. Keep going!</Text> 
        </View>
