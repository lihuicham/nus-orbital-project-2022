...
const READ = () => {
    ...
    const percentage = (average/readGoal) * 100;
  ...
  return (
    ...
    <View style={styles.container}>
        ...
        />
        <Text style={styles.percentText}>You've achieved <Text style={{fontSize: 20, fontWeight: '500', color: '#B1303B'}}>{ percentage.toPrecision(3) }%</Text> of your read goal. Keep going!</Text> 
        </View>
